...
import VirtStoreScreen from '@/screens/apps/VirtStoreScreen';

export type AppName = 'camera' | 'settings' | 'virt-ai' | 'clock' | 'calculator' | 'virt-store';
    ...
    <View style={styles.root}>
      ...
      {phase === 'home' && (
        <>
          ...
          {openApp === 'virt-store'  && <VirtStoreScreen  onClose={() => setOpenApp(null)} />}
        </>
      )}
    </View>
  );
